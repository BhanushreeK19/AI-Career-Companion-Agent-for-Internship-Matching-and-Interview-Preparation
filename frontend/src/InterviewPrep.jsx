  ...
  return (
    <div>
      <div className="page-header">
        ...
        <p>Personalized role recommendations, technical &amp; HR questions, answer guidance, and a prep roadmap — grounded in your parsed resume and any document you upload.</p>
      </div>
          ...
          <div className="chat-messages" ref={scrollRef}>
            {loadingMessages ? (
              ...
              <div className="chat-empty">
                <h2 style={{ fontSize: 16, color: "var(--text)" }}>Let's get you interview-ready</h2>
                <p>Try a quick prompt above, or ask: "What roles suit my resume?" or "Give me 5 technical questions for a backend role."</p>
              </div>
            ) : (
              messages.map((m) => (
